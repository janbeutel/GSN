...
public class DozerAdcComDiffDeprecatedMsg extends DataHeaderMsg {
    ...
    /** Create a new DozerAdcComDiffMsg of size 25. */
    public DozerAdcComDiffDeprecatedMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new DozerAdcComDiffMsg of the given data_length. */
    public DozerAdcComDiffDeprecatedMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }
     ...
     * and base offset.
     */
    public DozerAdcComDiffDeprecatedMsg(int data_length, int base_offset) {
     ...
     * as backing store.
     */
    public DozerAdcComDiffDeprecatedMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public DozerAdcComDiffDeprecatedMsg(byte[] data, int base_offset) {
     ...
     */
    public DozerAdcComDiffDeprecatedMsg(byte[] data, int base_offset, int data_length) {
     ...
     */
    public DozerAdcComDiffDeprecatedMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public DozerAdcComDiffDeprecatedMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      ...
      try {
        s += "  [payload.Adiff01_1=0x"+Long.toHexString(get_payload_Adiff01_1())+"]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      try {
        s += "  [payload.Adiff23_1=0x"+Long.toHexString(get_payload_Adiff23_1())+"]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      try {
        s += "  [payload.Adiff01_2=0x"+Long.toHexString(get_payload_Adiff01_2())+"]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      try {
        s += "  [payload.Adiff23_2=0x"+Long.toHexString(get_payload_Adiff23_2())+"]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      try {
        s += "  [payload.A=";
        for (int i = 0; i < 4; i++) {
          s += "0x"+Long.toHexString(getElement_payload_A(i) & 0xffff)+" ";
        }
        s += "]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      return s;
    ...
    /////////////////////////////////////////////////////////
    // Accessor methods for field: payload.Adiff01_1
    //   Field type: int
    //   Offset (bits): 72
    //   Size (bits): 16
    /////////////////////////////////////////////////////////
    ...
    /**
     * Return whether the field 'payload.Adiff01_1' is signed (false).
     */
    public static boolean isSigned_payload_Adiff01_1() {
        return false;
    }

    /**
     * Return whether the field 'payload.Adiff01_1' is an array (false).
     */
    public static boolean isArray_payload_Adiff01_1() {
        return false;
    }

    /**
     * Return the offset (in bytes) of the field 'payload.Adiff01_1'
     */
    public static int offset_payload_Adiff01_1() {
        return (72 / 8);
    }

    /**
     * Return the offset (in bits) of the field 'payload.Adiff01_1'
     */
    public static int offsetBits_payload_Adiff01_1() {
        return 72;
    }

    /**
     * Return the value (as a int) of the field 'payload.Adiff01_1'
     */
    public int get_payload_Adiff01_1() {
        return (int)getUIntBEElement(offsetBits_payload_Adiff01_1(), 16);
    }

    /**
     * Set the value of the field 'payload.Adiff01_1'
     */
    public void set_payload_Adiff01_1(int value) {
        setUIntBEElement(offsetBits_payload_Adiff01_1(), 16, value);
    }

    /**
     * Return the size, in bytes, of the field 'payload.Adiff01_1'
     */
    public static int size_payload_Adiff01_1() {
        return (16 / 8);
    }

    /**
     * Return the size, in bits, of the field 'payload.Adiff01_1'
     */
    public static int sizeBits_payload_Adiff01_1() {
        return 16;
    }

    /////////////////////////////////////////////////////////
    // Accessor methods for field: payload.Adiff23_1
    //   Field type: int
    //   Offset (bits): 88
    //   Size (bits): 16
    /////////////////////////////////////////////////////////
    ...
    /**
     * Return whether the field 'payload.Adiff23_1' is signed (false).
     */
    public static boolean isSigned_payload_Adiff23_1() {
        return false;
    }

    /**
     * Return whether the field 'payload.Adiff23_1' is an array (false).
     */
    public static boolean isArray_payload_Adiff23_1() {
        return false;
    }

    /**
     * Return the offset (in bytes) of the field 'payload.Adiff23_1'
     */
    public static int offset_payload_Adiff23_1() {
        return (88 / 8);
    }

    /**
     * Return the offset (in bits) of the field 'payload.Adiff23_1'
     */
    public static int offsetBits_payload_Adiff23_1() {
        return 88;
    }

    /**
     * Return the value (as a int) of the field 'payload.Adiff23_1'
     */
    public int get_payload_Adiff23_1() {
        return (int)getUIntBEElement(offsetBits_payload_Adiff23_1(), 16);
    }

    /**
     * Set the value of the field 'payload.Adiff23_1'
     */
    public void set_payload_Adiff23_1(int value) {
        setUIntBEElement(offsetBits_payload_Adiff23_1(), 16, value);
    }

    /**
     * Return the size, in bytes, of the field 'payload.Adiff23_1'
     */
    public static int size_payload_Adiff23_1() {
        return (16 / 8);
    }

    /**
     * Return the size, in bits, of the field 'payload.Adiff23_1'
     */
    public static int sizeBits_payload_Adiff23_1() {
        return 16;
    }

    /////////////////////////////////////////////////////////
    // Accessor methods for field: payload.Adiff01_2
    //   Field type: int
    //   Offset (bits): 104
    //   Size (bits): 16
    /////////////////////////////////////////////////////////
    ...
    /**
     * Return whether the field 'payload.Adiff01_2' is signed (false).
     */
    public static boolean isSigned_payload_Adiff01_2() {
        return false;
    }

    /**
     * Return whether the field 'payload.Adiff01_2' is an array (false).
     */
    public static boolean isArray_payload_Adiff01_2() {
        return false;
    }

    /**
     * Return the offset (in bytes) of the field 'payload.Adiff01_2'
     */
    public static int offset_payload_Adiff01_2() {
        return (104 / 8);
    }

    /**
     * Return the offset (in bits) of the field 'payload.Adiff01_2'
     */
    public static int offsetBits_payload_Adiff01_2() {
        return 104;
    }

    /**
     * Return the value (as a int) of the field 'payload.Adiff01_2'
     */
    public int get_payload_Adiff01_2() {
        return (int)getUIntBEElement(offsetBits_payload_Adiff01_2(), 16);
    }

    /**
     * Set the value of the field 'payload.Adiff01_2'
     */
    public void set_payload_Adiff01_2(int value) {
        setUIntBEElement(offsetBits_payload_Adiff01_2(), 16, value);
    }

    /**
     * Return the size, in bytes, of the field 'payload.Adiff01_2'
     */
    public static int size_payload_Adiff01_2() {
        return (16 / 8);
    }

    /**
     * Return the size, in bits, of the field 'payload.Adiff01_2'
     */
    public static int sizeBits_payload_Adiff01_2() {
        return 16;
    }

    /////////////////////////////////////////////////////////
    // Accessor methods for field: payload.Adiff23_2
    //   Field type: int
    //   Offset (bits): 120
    //   Size (bits): 16
    /////////////////////////////////////////////////////////
    ...
    /**
     * Return whether the field 'payload.Adiff23_2' is signed (false).
     */
    public static boolean isSigned_payload_Adiff23_2() {
        return false;
    }

    /**
     * Return whether the field 'payload.Adiff23_2' is an array (false).
     */
    public static boolean isArray_payload_Adiff23_2() {
        return false;
    }

    /**
     * Return the offset (in bytes) of the field 'payload.Adiff23_2'
     */
    public static int offset_payload_Adiff23_2() {
        return (120 / 8);
    }

    /**
     * Return the offset (in bits) of the field 'payload.Adiff23_2'
     */
    public static int offsetBits_payload_Adiff23_2() {
        return 120;
    }

    /**
     * Return the value (as a int) of the field 'payload.Adiff23_2'
     */
    public int get_payload_Adiff23_2() {
        return (int)getUIntBEElement(offsetBits_payload_Adiff23_2(), 16);
    }

    /**
     * Set the value of the field 'payload.Adiff23_2'
     */
    public void set_payload_Adiff23_2(int value) {
        setUIntBEElement(offsetBits_payload_Adiff23_2(), 16, value);
    }

    /**
     * Return the size, in bytes, of the field 'payload.Adiff23_2'
     */
    public static int size_payload_Adiff23_2() {
        return (16 / 8);
    }

    /**
     * Return the size, in bits, of the field 'payload.Adiff23_2'
     */
    public static int sizeBits_payload_Adiff23_2() {
        return 16;
    }

    /////////////////////////////////////////////////////////
    // Accessor methods for field: payload.A
    //   Field type: int[]
    //   Offset (bits): 136
    ...
    /**
     * Return whether the field 'payload.A' is signed (false).
     */
    public static boolean isSigned_payload_A() {
        return false;
    }

    /**
     * Return whether the field 'payload.A' is an array (true).
     */
    public static boolean isArray_payload_A() {
        return true;
    }

    /**
     * Return the offset (in bytes) of the field 'payload.A'
     */
    public static int offset_payload_A(int index1) {
        int offset = 136;
    ...
    /**
     * Return the offset (in bits) of the field 'payload.A'
     */
    public static int offsetBits_payload_A(int index1) {
        int offset = 136;
        if (index1 < 0 || index1 >= 4) throw new ArrayIndexOutOfBoundsException();
        offset += 0 + index1 * 16;
        return offset;
    ...
    /**
     * Set the contents of the array 'payload.A' from the given int[]
     */
    public void set_payload_A(int[] value) {
        for (int index0 = 0; index0 < value.length; index0++) {
            setElement_payload_A(index0, value[index0]);
        }
    }

    /**
     * Return an element (as a int) of the array 'payload.A'
     */
    public int getElement_payload_A(int index1) {
        return (int)getUIntBEElement(offsetBits_payload_A(index1), 16);
    }

    /**
     * Set an element of the array 'payload.A'
     */
    public void setElement_payload_A(int index1, int value) {
        setUIntBEElement(offsetBits_payload_A(index1), 16, value);
    }

    /**
     * Return the total size, in bytes, of the array 'payload.A'
     */
    public static int totalSize_payload_A() {
        return (64 / 8);
    }

    /**
     * Return the total size, in bits, of the array 'payload.A'
     */
    public static int totalSizeBits_payload_A() {
        return 64;
    }

    /**
     * Return the size, in bytes, of each element of the array 'payload.A'
     */
    public static int elementSize_payload_A() {
        return (16 / 8);
    }

    /**
     * Return the size, in bits, of each element of the array 'payload.A'
     */
    public static int elementSizeBits_payload_A() {
        return 16;
    }

    /**
     * Return the number of dimensions in the array 'payload.A'
     */
    public static int numDimensions_payload_A() {
        return 1;
    }

    /**
     * Return the number of elements in the array 'payload.A'
     */
    public static int numElements_payload_A() {
        return 4;
    }
     ...
     */
    public static int numElements_payload_A(int dimension) {
      int array_dims[] = { 4,  };
