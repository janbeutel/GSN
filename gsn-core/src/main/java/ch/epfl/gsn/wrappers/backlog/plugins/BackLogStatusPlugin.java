...
public class BackLogStatusPlugin extends AbstractPlugin {
	...
	private final transient Logger logger = LoggerFactory.getLogger( BackLogStatusPlugin.class );
	...
	public short getMessageType() {
		return ch.epfl.gsn.wrappers.backlog.BackLogMessage.BACKLOG_STATUS_MESSAGE_TYPE;
	}
