...
public class Sampler6712Plugin extends AbstractPlugin {
	...
	private final transient Logger logger = LoggerFactory.getLogger( Sampler6712Plugin.class );
	...
	public short getMessageType() {
		return ch.epfl.gsn.wrappers.backlog.BackLogMessage.SAMPLER_6712_MESSAGE_TYPE;
	}
