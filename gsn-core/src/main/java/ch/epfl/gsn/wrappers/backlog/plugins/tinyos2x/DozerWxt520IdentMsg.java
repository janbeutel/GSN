 ...
 * This class implements a Java interface to the 'DozerWxt520IdentMsg'
 * message type.
 */

 package ch.epfl.gsn.wrappers.backlog.plugins.tinyos2x;

public class DozerWxt520IdentMsg extends DataHeaderMsg {

    /** The default size of this message type in bytes. */
    public static final int DEFAULT_MESSAGE_SIZE = 18;

    /** The Active Message type associated with this message. */
    public static final int AM_TYPE = 166;

    /** Create a new DozerWxt520IdentMsg of size 18. */
    public DozerWxt520IdentMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new DozerWxt520IdentMsg of the given data_length. */
    public DozerWxt520IdentMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DozerWxt520IdentMsg with the given data_length
     * and base offset.
     */
    public DozerWxt520IdentMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DozerWxt520IdentMsg using the given byte array
     * as backing store.
     */
    public DozerWxt520IdentMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public DozerWxt520IdentMsg(byte[] data, int base_offset) {
     ...
     */
    public DozerWxt520IdentMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DozerWxt520IdentMsg embedded in the given message
     * at the given base offset.
     */
    public DozerWxt520IdentMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public DozerWxt520IdentMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <DozerWxt520IdentMsg> \n";
      try {
