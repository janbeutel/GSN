...
public class DozerWxt520PrecMsg extends DataHeaderMsg {
    ...
    /**
     * Return the value (as a int) of the field 'payload.Ru_Rc'
     */
    public int get_payload_Ru_Rc() {
        return (int)getUIntBEElement(offsetBits_payload_Ru_Rc(), 16);
    }

    /**
     * Set the value of the field 'payload.Ru_Rc'
     */
    public void set_payload_Ru_Rc(int value) {
    	setUIntBEElement(offsetBits_payload_Ru_Rc(), 16, value);
    }
    ...
    /**
     * Return the value (as a long) of the field 'payload.Ru_Rd'
     */
    public long get_payload_Ru_Rd() {
        return (long)getUIntBEElement(offsetBits_payload_Ru_Rd(), 32);
    }

    /**
     * Set the value of the field 'payload.Ru_Rd'
     */
    public void set_payload_Ru_Rd(long value) {
        setUIntBEElement(offsetBits_payload_Ru_Rd(), 32, value);
    }
    ...
    /**
     * Return the value (as a int) of the field 'payload.Ru_Ri'
     */
    public int get_payload_Ru_Ri() {
        return (int)getUIntBEElement(offsetBits_payload_Ru_Ri(), 16);
    }

    /**
     * Set the value of the field 'payload.Ru_Ri'
     */
    public void set_payload_Ru_Ri(int value) {
        setUIntBEElement(offsetBits_payload_Ru_Ri(), 16, value);
    }
    ...
    /**
     * Return the value (as a int) of the field 'payload.Ru_Hc'
     */
    public int get_payload_Ru_Hc() {
        return (int)getUIntBEElement(offsetBits_payload_Ru_Hc(), 16);
    }

    /**
     * Set the value of the field 'payload.Ru_Hc'
     */
    public void set_payload_Ru_Hc(int value) {
        setUIntBEElement(offsetBits_payload_Ru_Hc(), 16, value);
    }
    ...
    /**
     * Return the value (as a long) of the field 'payload.Ru_Hd'
     */
    public long get_payload_Ru_Hd() {
        return (long)getUIntBEElement(offsetBits_payload_Ru_Hd(), 32);
    }

    /**
     * Set the value of the field 'payload.Ru_Hd'
     */
    public void set_payload_Ru_Hd(long value) {
        setUIntBEElement(offsetBits_payload_Ru_Hd(), 32, value);
    }
    ...
    /**
     * Return the value (as a int) of the field 'payload.Ru_Hi'
     */
    public int get_payload_Ru_Hi() {
        return (int)getUIntBEElement(offsetBits_payload_Ru_Hi(), 16);
    }

    /**
     * Set the value of the field 'payload.Ru_Hi'
     */
    public void set_payload_Ru_Hi(int value) {
        setUIntBEElement(offsetBits_payload_Ru_Hi(), 16, value);
    }
    ...
    /**
     * Return the value (as a int) of the field 'payload.Ru_Rp'
     */
    public int get_payload_Ru_Rp() {
        return (int)getUIntBEElement(offsetBits_payload_Ru_Rp(), 16);
    }

    /**
     * Set the value of the field 'payload.Ru_Rp'
     */
    public void set_payload_Ru_Rp(int value) {
        setUIntBEElement(offsetBits_payload_Ru_Rp(), 16, value);
    }
    ...
    /**
     * Return the value (as a int) of the field 'payload.Ru_Hp'
     */
    public int get_payload_Ru_Hp() {
        return (int)getUIntBEElement(offsetBits_payload_Ru_Hp(), 16);
    }

    /**
     * Set the value of the field 'payload.Ru_Hp'
     */
    public void set_payload_Ru_Hp(int value) {
        setUIntBEElement(offsetBits_payload_Ru_Hp(), 16, value);
    }
