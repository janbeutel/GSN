...
public class CoreStationStatusPlugin extends AbstractPlugin {
	...
	private static DataField[] hwDataField = {
			...
			new DataField("BAT_REM_TIME_DIFF", "BIGINT"),
	...
	private final transient Logger logger = LoggerFactory.getLogger( CoreStationStatusPlugin.class );
	...
	public short getMessageType() {
		return ch.epfl.gsn.wrappers.backlog.BackLogMessage.CORESTATION_STATUS_MESSAGE_TYPE;
	}
