...
public class VaisalaWXT520Plugin extends AbstractPlugin {
	...
	private final transient Logger logger = LoggerFactory.getLogger( VaisalaWXT520Plugin.class );

	@Override
	public short getMessageType() {
		return ch.epfl.gsn.wrappers.backlog.BackLogMessage.VAISALA_WXT520_MESSAGE_TYPE;
	}
