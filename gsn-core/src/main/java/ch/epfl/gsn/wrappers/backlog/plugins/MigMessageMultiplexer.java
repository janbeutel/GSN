...
import ch.epfl.gsn.wrappers.backlog.sf.SFListen;
import ch.epfl.gsn.wrappers.backlog.sf.SFv1Listen;
...
public class MigMessageMultiplexer implements BackLogMessageListener {
	...
	private final transient Logger logger = LoggerFactory.getLogger( MigMessageMultiplexer.class );
