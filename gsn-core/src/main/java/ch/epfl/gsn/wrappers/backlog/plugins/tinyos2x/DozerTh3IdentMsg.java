 ...
 * This class implements a Java interface to the 'DozerTh3IdentMsg'
 * message type.
 */

 package ch.epfl.gsn.wrappers.backlog.plugins.tinyos2x;

public class DozerTh3IdentMsg extends DataHeaderMsg {
    ...
    /** Create a new DozerTh3IdentMsg of size 18. */
    public DozerTh3IdentMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new DozerTh3IdentMsg of the given data_length. */
    public DozerTh3IdentMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DozerTh3IdentMsg with the given data_length
     * and base offset.
     */
    public DozerTh3IdentMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DozerTh3IdentMsg using the given byte array
     * as backing store.
     */
    public DozerTh3IdentMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public DozerTh3IdentMsg(byte[] data, int base_offset) {
     ...
     */
    public DozerTh3IdentMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DozerTh3IdentMsg embedded in the given message
     * at the given base offset.
     */
    public DozerTh3IdentMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public DozerTh3IdentMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <DozerTh3IdentMsg> \n";
      try {
