error id: file://<WORKSPACE>/gsn-tools/src/main/scala/ch/epfl/gsn/config/VsConf.scala:String#
...
case class ProcessingConf(className:Stri@@ng,uniqueTimestamp:Boolean,initParams:Map[String,String],
