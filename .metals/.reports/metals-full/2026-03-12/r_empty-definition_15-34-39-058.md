error id: file://<WORKSPACE>/gsn-tools/src/main/scala/ch/epfl/gsn/config/VsConf.scala:
file://<WORKSPACE>/gsn-tools/src/main/scala/ch/epfl/gsn/config/VsConf.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -xml/FieldConf#
	 -play/api/libs/json/FieldConf#
	 -FieldConf#
	 -scala/Predef.FieldConf#
offset: 3051
uri: file://<WORKSPACE>/gsn-tools/src/main/scala/ch/epfl/gsn/config/VsConf.scala
text:
```scala
/**
...
case class ProcessingConf(className:String,uniqueTimestamp:Boolean,initParams:Map[String,String],
    rate:Option[Int],output:Seq[Field@@Conf],webInput:Option[WebInputConf], partitionField:Option[String])
