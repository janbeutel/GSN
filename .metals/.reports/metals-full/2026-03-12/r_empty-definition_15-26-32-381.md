error id: file://<WORKSPACE>/gsn-services/app/controllers/gsn/api/SensorService.scala:
file://<WORKSPACE>/gsn-services/app/controllers/gsn/api/SensorService.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scala/collection/JavaConverters.GetSensorConf.
	 -scala/collection/JavaConverters.GetSensorConf#
	 -scala/collection/JavaConverters.GetSensorConf().
	 -scala/concurrent/duration/GetSensorConf.
	 -scala/concurrent/duration/GetSensorConf#
	 -scala/concurrent/duration/GetSensorConf().
	 -akka/actor/GetSensorConf.
	 -akka/actor/GetSensorConf#
	 -akka/actor/GetSensorConf().
	 -play/api/mvc/GetSensorConf.
	 -play/api/mvc/GetSensorConf#
	 -play/api/mvc/GetSensorConf().
	 -ch/epfl/gsn/data/GetSensorConf.
	 -ch/epfl/gsn/data/GetSensorConf#
	 -ch/epfl/gsn/data/GetSensorConf().
	 -ch/epfl/gsn/data/format/GetSensorConf.
	 -ch/epfl/gsn/data/format/GetSensorConf#
	 -ch/epfl/gsn/data/format/GetSensorConf().
	 -ch/epfl/gsn/config/GetSensorConf.
	 -ch/epfl/gsn/config/GetSensorConf#
	 -ch/epfl/gsn/config/GetSensorConf().
	 -play/api/mvc/Results.GetSensorConf.
	 -play/api/mvc/Results.GetSensorConf#
	 -play/api/mvc/Results.GetSensorConf().
	 -GetSensorConf.
	 -GetSensorConf#
	 -GetSensorConf().
	 -scala/Predef.GetSensorConf.
	 -scala/Predef.GetSensorConf#
	 -scala/Predef.GetSensorConf().
offset: 6008
uri: file://<WORKSPACE>/gsn-services/app/controllers/gsn/api/SensorService.scala
text:
```scala
/**
  ...
  */    
  ...
  def uploadSensorData(sensorid:String) = headings((APIPermissionAction(playAuth,true, sensorid) compose Action).async {implicit request =>
    Try{
      ...
      val p = q ? GetSen@@sorConf(sensorid)
      p.map{c => c match{
        case conf:VsConf => {
