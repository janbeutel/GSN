error id: file://<WORKSPACE>/gsn-core/src/main/java/ch/epfl/gsn/config/WebInputConf.java
file://<WORKSPACE>/gsn-core/src/main/java/ch/epfl/gsn/config/WebInputConf.java
...
```java
offset: 0
uri: file://<WORKSPACE>/gsn-core/src/main/java/ch/epfl/gsn/config/WebInputConf.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/gsn-core/src/main/java/ch/epfl/gsn/config/WebInputConf.java