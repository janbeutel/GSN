error id: file://<WORKSPACE>/gsn-tools/src/main/scala/ch/epfl/gsn/config/GsnConf.scala:Conf#
file://<WORKSPACE>/gsn-tools/src/main/scala/ch/epfl/gsn/config/GsnConf.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -xml/Conf#
	 -play/api/libs/json/Conf#
	 -Conf#
	 -scala/Predef.Conf#
offset: 2066
uri: file://<WORKSPACE>/gsn-tools/src/main/scala/ch/epfl/gsn/config/GsnConf.scala
text:
```scala
/**
