error id: file://<WORKSPACE>/gsn-core/src/main/java/ch/epfl/gsn/config/GsnConf.java:_empty_/JacksonXmlProperty#
file://<WORKSPACE>/gsn-core/src/main/java/ch/epfl/gsn/config/GsnConf.java
empty definition using pc, found symbol in pc: _empty_/JacksonXmlProperty#
...
public class GsnConf {
    ...
    @JsonCreator
    public GsnConf(
        @JacksonXmlProperty("monitor-port") int monitorPort,
        @JsonProperty("time-format") String timeFormat,
        @Jacks@@onXmlProperty("zmq-conf") ZmqConf zmqConf, // Assuming tag name
