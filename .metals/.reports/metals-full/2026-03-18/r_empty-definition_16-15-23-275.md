error id: file://<WORKSPACE>/gsn-core/src/main/java/ch/epfl/gsn/config/ConfigLoader.java:_empty_/XmlMapper#
file://<WORKSPACE>/gsn-core/src/main/java/ch/epfl/gsn/config/ConfigLoader.java
empty definition using pc, found symbol in pc: _empty_/XmlMapper#
...
public class ConfigLoader {
    private static final XmlM@@apper mapper = new XmlMapper();
