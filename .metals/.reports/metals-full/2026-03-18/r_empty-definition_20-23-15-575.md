error id: file://<WORKSPACE>/gsn-tools/src/main/scala/ch/epfl/gsn/data/format/ShapefileSerializer.scala:DefaultTransaction.
file://<WORKSPACE>/gsn-tools/src/main/scala/ch/epfl/gsn/data/format/ShapefileSerializer.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -ch/epfl/gsn/data/DefaultTransaction.
	 -ch/epfl/gsn/data/DefaultTransaction#
	 -ch/epfl/gsn/data/DefaultTransaction().
	 ...
	 -DefaultTransaction#
	 -DefaultTransaction().
	 -scala/Predef.DefaultTransaction.
	 -scala/Predef.DefaultTransaction#
	 -scala/Predef.DefaultTransaction().
offset: 1303
uri: file://<WORKSPACE>/gsn-tools/src/main/scala/ch/epfl/gsn/data/format/ShapefileSerializer.scala
text:
```scala
/**
...
import org.geotools.data.DefaultTran@@saction
